...
def parse_arguments():
    ...
    parser.add_argument('--query_paths', type=str, nargs="+", default=["/space/grp/rschwartz/rschwartz/get_gemma_data.nf/all_homo_sapiens_samples/h5ad/PTSDBrainomics/PTSDBrainomics_1203506_sc2.h5ad",
                                                                                "/space/grp/rschwartz/rschwartz/get_gemma_data.nf/all_homo_sapiens_samples/h5ad/PTSDBrainomics/PTSDBrainomics_1203507_sc1.h5ad",
                                                                                "/space/grp/rschwartz/rschwartz/get_gemma_data.nf/all_homo_sapiens_samples/h5ad/PTSDBrainomics/PTSDBrainomics_1203508_sc3.h5ad"])
