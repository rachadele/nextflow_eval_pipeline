process REF_PROCESS_SEURAT {
    ...
    storeDir "/cosmos/data/nextflow-eval-pipeline/results/cache/refs_seurat/${params.git_branch}/${params.organism}/${params.census_version}/${params.organ}/${params.ref_split}/sub_${params.subsample_ref}/${params.normalization_method}/dims_${params.dims}/feat_${params.nfeatures}/batch_${params.batch_correct}"
