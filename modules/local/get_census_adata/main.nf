process GET_CENSUS_ADATA {
    ...
    storeDir "/cosmos/data/nextflow-eval-pipeline/results/cache/refs/${params.git_branch}/${params.organism}/${params.census_version}/${params.organ}/${params.ref_split}/sub_${params.subsample_ref}"
